...
check('backup_app_version', 'const APP_VERSION = "5.1.0";' in backup)
check('db_app_version', 'const APP_VERSION = "5.1.0";' in db)
...
for required in ['calendario/modifica/index.html','calendario/gestisci/index.html','calendario/componi/index.html','preferenze/index.html','offline/index.html']:
